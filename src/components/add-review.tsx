...
const AddReview: React.FC<AddReviewProps> = ({
  ...
  return (
    <Button
      className="flex items-center px-5 py-1 text-white bg-tyvc-green border rounded-md border-tyvc-green hover:opacity-75 active:bg-green-400 active:border-green-400 dark:text-white dark:bg-dark-accent"
