...
const Review: FC<ReviewProps> = ({ review }) => {
  ...
  return (
    <Card
        className="relative w-4/5 min-h-[20vh] max-w-[80vh]"
    >
        <CardContent>

        <div className="header flex justify-between items-center py-3">
            <div className='fheader'>
                <h2 className="flex-grow text-2xl font-semibold">{review.headline}</h2>
            </div>
            <div className=' '>
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div className="inline-flex items-center gap-2 px-2 py-1 text-white bg-tyvc-green border rounded-md border-tyvc-green">
                                <svg className="shrink-0 ml-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <TooltipContent className='flex'>
                        <p>{review.labels.founderReceivedInvestment} {review.investor_name}</p>
        ...
        <div className="header flex justify-between items-center pt-5">
            <div className='flex gap-2'>
                <div className="inline-flex items-center gap-1">
                    <span className='text-sm font-semibold'>{review.tyvcscore},0</span>
            ...
            <div className="dat text-xs text-gray-500">
                {review.date}
            </div>
        </div>
        ...
        <div className='criteria pt-4'>
            ...
            <div className="w-full">
                <CollapsibleTrigger asChild>
                    <Button className="inline-flex justify-start items-center gap-2 px-1 text-blue-500" variant="ghost" size="sm">
            ...
            <CollapsibleContent className="w-full space-y-2">
                <div className="w-full flex">
                    ...
                    <div className='overall-score w-1/5 flex flex-col items-center'>
                        ...
                        <Rating stars={3}/>
                        <span className='pt-3 text-5xl font-bold'>{review.tyvcscore},0</span>
        ...
        <div className="footer flex justify-between pt-4">
            <div className='helpfulness'>
                ...
                <Button className="inline-flex justify-start items-center p-2 text-gray-600 bg-gray-200">
                    ...
                    <span>{review.helpfulness} {review.labels.foundersFoundReviewHelpful}<span className='text-blue-600 underline'>{review.labels.youToo}You too?</span></span>
                </Button>
            ...
            <div className='connect'>
                <AlertDialog>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                        <AlertDialogTitle>{review.labels.sendConnectionRequest} Send out a connection request to {review.author}</AlertDialogTitle>
                        <AlertDialogDescription>
                            {review.author} {review.labels.authorWillReceiveMail} will receive a mail about the connectio request.
                            {review.labels.whenAuthorAccepts} When the author accepts the request you get access to their LinkedIn
                        </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                        <AlertDialogCancel>{review.labels.cancel}</AlertDialogCancel>
                        <AlertDialogAction>{review.labels.continue}</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
            </div>
